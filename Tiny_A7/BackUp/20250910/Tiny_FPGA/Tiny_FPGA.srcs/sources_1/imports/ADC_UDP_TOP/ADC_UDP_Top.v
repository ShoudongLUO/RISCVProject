...
module ADC_UDP_top #(
    ...
    wire [ADC_CHANEL*DATAWIDTH-1:0] cal_adc_value;
    wire [ADC_CHANEL*DATAWIDTH-1:0] adc_test;
    wire data_accepted_rib;
    wire [ADC_CHANEL*ADC_WIDTH-1:0] adc_data_dly;
    ...
    wire udp_tx_done;
    wire tx_req;
    wire [ADC_CHANEL*DATAWIDTH-1:0] udp_tx_data;
    wire udp_busy;

    // top_ctrl module signals
    wire ctrl_fifo_wr_en;
    wire ctrl_udp_tx_enable;
