...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../Tiny_FPGA.gen/sources_1/ip/ila_0_1/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Tiny_FPGA.gen/sources_1/ip/ila_0_1/hdl/verilog" \
