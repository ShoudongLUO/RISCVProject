 ...
 *  Log (开发日志):
    ...
    2. SGMII version - replaced RGMII with SGMII PHY interface
 * =========================================================== */
 /*
...
// tinyriscv soc顶层模块 (SGMII version)
module tinyriscv_soc_top_sgmii(
    ...
    // Clock/Reset Output (from PCS/PMA, optional external use)
